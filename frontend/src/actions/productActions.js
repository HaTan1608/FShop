...
export const listProductsHome = () => async (dispatch) => {
    dispatch({
        type: PRODUCT_HOME_REQUEST
    });
    try {
        const { data } = await axios.get(
            '/api/products/home'
